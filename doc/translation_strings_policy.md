...
This document provides guidelines for internationalization of the Karmacoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `karmacoin_en.ts` remains unchanged.
