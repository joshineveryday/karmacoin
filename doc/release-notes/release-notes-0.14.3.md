Karmacoin Core version *0.14.3* is now available from:

  <https://karmacoin.org/bin/karmacoin-core-0.14.3/>
...
- #10451 `3612219` contrib/init/karmacoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
