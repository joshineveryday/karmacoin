Karmacoin Core version 0.16.1 is now available from:

  <https://karmacoincore.org/bin/karmacoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting karmacoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure karmacoind processes are cleaned up when tests end (sdaftuar)
