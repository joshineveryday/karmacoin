Karmacoin Core version 0.13.2 is now available from:

  <https://karmacoin.org/bin/karmacoin-core-0.13.2/>
...
- #8908 `4a974b2` Update karmacoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow karmacoin-tx to create v2 transactions (btcdrak)
