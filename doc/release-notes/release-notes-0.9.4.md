Karmacoin Core version 0.9.4 is now available from:

  https://karmacoin.org/bin/0.9.4/
...
this update is incompatible with the Karmacoin system and could lead to consensus
forks.

Karmacoin Core released binaries from https://karmacoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~karmacoin/+archive/ubuntu/karmacoin
- A third-party or self-compiled Karmacoin Core

upgrade to Karmacoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
