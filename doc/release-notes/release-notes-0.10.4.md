Karmacoin Core version 0.10.4 is now available from:

  <https://karmacoin.org/bin/karmacoin-core-0.10.4/>
...
- #6953 `43c2789` Split karmacoin-tx into its own package
- #6953 `dfe0d4d` Include karmacoin-tx binary on Debian/Ubuntu
