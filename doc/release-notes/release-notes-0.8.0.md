Karmacoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/karmacoin/files/Karmacoin/karmacoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Karmacoin
...
New/changed settings (command-line or karmacoin.conf file)
--------------------------------------------------------
