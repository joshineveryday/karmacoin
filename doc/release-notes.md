*After branching off for a major version release of Karmacoin Core, use this
...
https://github.com/karmacoin-core/karmacoin-devwiki/wiki/
...
Karmacoin Core version *version* is now available from:

  <https://karmacoincore.org/bin/karmacoin-core-*version*/>
...
Upgrading directly from a version of Karmacoin Core that has reached its EOL is
possible, but might take some time if the datadir needs to be migrated.  Old
wallet versions of Karmacoin Core are generally supported.
...
Karmacoin Core is supported and extensively tested on operating systems using
the Linux kernel, macOS 10.10+, and Windows 7 and newer.  It is not recommended
to use Karmacoin Core on unsupported systems.
...
- When fetching a transaction announced by multiple peers, previous versions of
  Karmacoin Core would sequentially attempt to download the transaction from each
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/karmacoin/karmacoin/).
