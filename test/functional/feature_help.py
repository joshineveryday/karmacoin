...
"""Verify that starting karmacoin with -h works as expected."""

from test_framework.test_framework import KarmacoinTestFramework
from test_framework.util import assert_equal

class HelpTest(KarmacoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start karmacoin with -h for help text")
        ...
        self.log.info("Start karmacoin with -version for version information")
        ...
        self.log.info("Start karmacoind with -fakearg to make sure it does not start")
