...
// karmacoin includes.
#include <..\src\script\karmacoinconsensus.h>
...
int main()
{
    std::cout << "karmacoinconsensus version: " << karmacoinconsensus_version() << std::endl;
    ...
    auto op0Result = karmacoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, karmacoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
