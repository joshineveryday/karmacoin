# Bootstrappable Karmacoin Core Builds

This directory contains the files necessary to perform bootstrappable Karmacoin
Core builds.
...
- 24GB of free disk space on the partition that the Karmacoin Core git repository
  resides in
...
For a Karmacoin Core depends development environment, simply invoke
...
From the top of a clean Karmacoin Core repository:
...
To use dongcarl's substitute server for Karmacoin Core builds after having
