...
(define* (make-karmacoin-cross-toolchain target
                                  #:key
...
desirable for building Karmacoin Core release binaries."
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-karmacoin-cross-toolchain "i686-linux-gnu")
       (make-karmacoin-cross-toolchain "x86_64-linux-gnu")
       (make-karmacoin-cross-toolchain "aarch64-linux-gnu")
       (make-karmacoin-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-karmacoin-cross-toolchain "riscv64-linux-gnu"
