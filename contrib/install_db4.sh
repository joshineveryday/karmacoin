...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the karmacoin repository."
  exit 1
fi
...
# See https://github.com/karmacoin/karmacoin/issues/16064
...
echo 'When compiling karmacoind, run `./configure` in the following way:'
echo
