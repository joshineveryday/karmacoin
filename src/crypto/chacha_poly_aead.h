...
#ifndef KARMACOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define KARMACOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@karmacoin.
 *
 ...
 *
 * The chacha20-poly1305@karmacoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@karmacoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@karmacoin are relatively fast in
...
#endif // KARMACOIN_CRYPTO_CHACHA_POLY_AEAD_H
