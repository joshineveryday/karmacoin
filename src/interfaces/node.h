...
#ifndef KARMACOIN_INTERFACES_NODE_H
#define KARMACOIN_INTERFACES_NODE_H
...
//! Top-level interface for a karmacoin node (karmacoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // KARMACOIN_INTERFACES_NODE_H
