...
#ifndef KARMACOIN_TEST_SCRIPTNUM10_H
#define KARMACOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Karmacoin Core 0.10.0, for cross-comparison.
 */
public:
