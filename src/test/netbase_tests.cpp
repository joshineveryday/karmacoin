// Copyright (c) 2012-2019 The Karmacoin Core developers
...
{
    BOOST_CHECK(TestSplitHost("www.karmacoincore.org", "www.karmacoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.karmacoincore.org]", "www.karmacoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.karmacoincore.org:80", "www.karmacoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.karmacoincore.org]:80", "www.karmacoincore.org", 80));
