...
#ifndef KARMACOIN_SCRIPT_STANDARD_H
#define KARMACOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a karmacoin address
 */
...
/**
 * Generate a Karmacoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // KARMACOIN_SCRIPT_STANDARD_H
