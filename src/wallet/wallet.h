...
#ifndef KARMACOIN_WALLET_WALLET_H
#define KARMACOIN_WALLET_WALLET_H
...
enum WalletFlags : uint64_t {
    ...
    //! karmacoin from opening the wallet, thinking it was newly created, and
 ...
 * change.
 *
 * The Karmacoin Core wallet was originally a collection of unrelated private
...
public:
     ...
     * on this karmacoin node, and set to 0 for transactions that were created
...
#endif // KARMACOIN_WALLET_WALLET_H
