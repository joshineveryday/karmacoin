...
#ifndef KARMACOIN_COMPAT_ASSUMPTIONS_H
#define KARMACOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Karmacoin cannot be compiled without assertions."
#endif
...
#endif // KARMACOIN_COMPAT_ASSUMPTIONS_H
