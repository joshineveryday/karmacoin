    ...
    platformStyle(_platformStyle)
{
    ...
    // normal karmacoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying karmacoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &KarmacoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
