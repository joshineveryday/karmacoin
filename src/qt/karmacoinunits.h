...
#ifndef KARMACOIN_QT_KARMACOINUNITS_H
#define KARMACOIN_QT_KARMACOINUNITS_H
...
/** Karmacoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class KarmacoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit KarmacoinUnits(QObject *parent);

    /** Karmacoin units.
      @note Source: https://en.karmacoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef KarmacoinUnits::Unit KarmacoinUnit;

#endif // KARMACOIN_QT_KARMACOINUNITS_H
