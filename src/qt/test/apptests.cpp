...
//! Entry point for KarmacoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &KarmacoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for KarmacoinGUI tests.
void AppTests::guiTests(KarmacoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &KarmacoinGUI::consoleShown, this, &AppTests::consoleTests);
