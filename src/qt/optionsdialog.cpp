    ...
    mapper(nullptr)
{
    ...
    ui->karmacoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->karmacoinAtStartup);
    ...
    ui->karmacoinAtStartup->setToolTip(ui->karmacoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->karmacoinAtStartup->setText(ui->karmacoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openKarmacoinConfButton->setToolTip(ui->openKarmacoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new KarmacoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->karmacoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openKarmacoinConfButton_clicked()
{
