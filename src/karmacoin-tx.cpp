...
static void SetupKarmacoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " karmacoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  karmacoin-tx [options] <hex-tx> [commands]  Update hex-encoded karmacoin transaction\n" +
            "or:     karmacoin-tx [options] -create [commands]   Create hex-encoded karmacoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded karmacoin transaction
